...
class PlayableEmbeds : Plugin() {
    ...
    private val youtubeUrlRe = Regex("(?:https?:\\/\\/)?(?:(?:www|m)\\.)?(?:youtu\\.be\\/|youtube(?:-no***REMOVED***)?\\.com\\/(?:embed\\/|v\\/|watch\\?v=|watch\\?.+&v=))((\\w|-){11})(?:\\S+)?")
                ...
                """
                        <html>
                            ...
                            <body>
                                <div class="wrapper">
                                    <iframe
                                        src="https://www.youtube-no***REMOVED***.com/embed/$videoId"
