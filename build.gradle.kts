...
subprojects {
    ...
    aliucord {
        ...
        updateUrl.set("https://raw.githubusercontent.com/Enovale/AliucordPlugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/Enovale/AliucordPlugins/builds/%s.zip")
    }
